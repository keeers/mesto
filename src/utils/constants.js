...
export const deleteButtonSelector = '.card__delete-btn';
export const deleteCardSelector = '.card_is-deleting';
export const deleteCardClassSelector = 'card_is-deleting';
export const inactiveDeleteButtonSelector = 'card__delete-btn_disabled'
export const profileNameSelector = '.profile__name';
export const profileJobSelector = '.profile__job';
export const submitEditSelector = '.popup__save-btn_type_edit';
export const submitAddSelector = '.popup__save-btn_type_add';
export const submitAvatarSelector = '.popup__save-btn_type_edit-avatar';
